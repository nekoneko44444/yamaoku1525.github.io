(function () {
  ...
  ready(function () {
    ...
    section.innerHTML = `
      ...
      <div class="kito-quest-body">
        <nav class="kito-map" aria-label="木頭クエストの章" data-kito-map></nav>
        <article class="kito-stage-card">
          <div class="kito-stage-meta" data-kito-place>木頭図書館</div>
          <h3 data-kito-title></h3>
          <div class="kito-story" data-kito-text></div>
          <div class="kito-story" data-kito-quote></div>
          <p class="kito-question" data-kito-mission></p>
          <div class="kito-actions">
            <button class="btn btn-outline" type="button" data-kito-prev>前の章</button>
            <button class="btn btn-primary" type="button" data-kito-next>次の章</button>
          </div>
